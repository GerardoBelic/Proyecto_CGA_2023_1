...
layout (std430, binding = 6) buffer vertexPositions
{
	vec4 vertexPos[];
};
...
void main(){
	...
	if (recording == 1){
		vertexPos[gl_VertexID] = fragPosWorldSpace;
	}
	
	vertexPos[gl_VertexID] = vec4(1.0, 2.0, 3.0, 1.0);
