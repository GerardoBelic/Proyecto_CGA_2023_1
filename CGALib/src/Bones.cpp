...
float Bones::bonesTransform(float timeInSeconds,
	...
	//std::cout << animationTime / scene->mAnimations[animationIndex]->mDuration << "\n";
	...
	return animationTime / scene->mAnimations[animationIndex]->mDuration;
